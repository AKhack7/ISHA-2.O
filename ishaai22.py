...
class IshaAssistant:
    ...
    def wish_me(self):
        ...
        self.speak(greeting)
        self.speak("I am Isha, Intelligent System for Human Assistance. Welcome!")
...
# Handle Gemini API queries
        ...
        elif command in ["open file m", "open file explorer" , "open file manager" , "open file manager" , "isha open file manager" , "file manager" , "isha open file explorer" , "open file explorer" , "file explorer"]:
        ...
        elif command in ["open xbox", "game bar" , "open game bar" , "open xbox" , "isha open game bar" , "isha open xbox" , "xbox" , "game bar"]:
            self.open_game_bar()
        ...
        elif "isha play song" in command or "play song" in command or "play music" in command or "isha play song" in command or "isha play music" in command or "isha play the song" in command or "isha play the music" in command:
            self.play_song()
